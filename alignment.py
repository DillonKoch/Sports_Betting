...
# Author: Dillon Koch
# -----
# Last Modified: Sunday, 7th June 2020 9:16:54 am
...
class Alignment:
    def __init__(self, league):
        self.league = league
        self.teams = os.listdir("./Data/{}/".format(self.league))  # Tested

    @property
    def odds_conversion_dict(self):  # Property Tested
        conversion_dict = {
    ...
    @property
    def season_start_dict(self):  # Property Tested
        start_dict = {
    ...
    def _add_datetime(self, df):  # Specific Helper load_espn_data  Tested
        def add_dt(row):
    ...
    def join_odds_espn(self, espn_df, odds_df):  # Top Level
        for i in range(len(espn_df)):
            espn_row = espn_df.iloc[i, :]
