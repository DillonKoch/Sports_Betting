# ==============================================================================
# File: sbro_scraper.py
# Project: allison
# File Created: Thursday, 25th August 2022 8:20:34 pm
# Author: Dillon Koch
# -----
# Last Modified: Thursday, 25th August 2022 8:20:34 pm
# Modified By: Dillon Koch
# -----
#
# -----
# Sportsbook Reviews Online scraper
# ==============================================================================
...
class Sbro_Scraper:
    ...
    def download_past_yr(self, league, url):  # Top Level
        ...
        output_path = ROOT_PATH + f"/Data/SBRO/{league}/{filename}"
    ...
    def _download_temp_df(self, url):  # Helping Helper _update_current_year
        ...
        """
        temp_path = ROOT_PATH + "/Data/SBRO/temp.xlsx"
    ...
    def download_current_yr(self, league, url):  # Top Level
        ...
        """
        filename = url.split('/')[-1]
        full_path = ROOT_PATH + f"/Data/SBRO/{league}/{filename}"
