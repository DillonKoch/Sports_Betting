...
class Clean_SBRO:
    ...
    def _odds_path_to_season(self, odds_path):  # Specific Helper  clean_df
        """
    ...
    def _clean_values(self, df, season):  # Specific Helper clean_df
        """
    ...
    def _odds_df_to_row_pairs(self, odds_df):  # Specific Helper  clean_df
        """
    ...
    def _check_game_in_january(self, row_pair):  # Specific Helper clean_df
        """
    ...
    def _row_pair_to_df(self, row_pair, df, season, seen_january):  # Specific Helper clean_df
        """
    ...
    def clean_df(self, df, path):  # Top Level
        ...
        df = self._clean_values(df, season)
